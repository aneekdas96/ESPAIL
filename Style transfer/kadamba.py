...
if __name__ == "__main__":
    ...
    #end_list = [(1,4),(5,24),(25,36),(37,41),(42,173),(174,183),(184,200),(201,208),(209,392),(412,426)]
    end_list = [(703, 711), (712, 723), (724, 732), (733, 910), (911, 922), (923, 934)]
                #    (184, 200), (201, 208), (209, 392),
                # (412, 426)]
    ...
    for j in end_list:
        ...
        print(num)
        num += '.jpg'
        args.input = 'image\\content\\frame_' + num
        args.input = 'image\\content\\frame_' + num
        y = main(args)
        for i in range(j[0],j[1]):
            ...
            num+='.jpg'
            args.input = 'image\\content\\frame_'+num
            imsave('%s_output.png' % args.input[-14:-4], y)
            print("Finished")
        for temp in range(15):gc.collect()
        K.clear_session()
